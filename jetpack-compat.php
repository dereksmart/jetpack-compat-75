<?php
/**
 * Plugin Name: Jetpack Compatibility
...
define( 'JETPACK_COMPAT__PLUGIN_DIR',           plugin_dir_path( __FILE__ ) );
 ...
 */
$jetpack_autoloader = JETPACK_COMPAT__PLUGIN_DIR . 'vendor/autoload_packages.php';
if ( is_readable( $jetpack_autoloader ) ) {
	 ...
	 * @since 7.4.0
	 */
	if ( ! function_exists( 'jetpack_admin_missing_autoloader' ) ) {
...
require_once JETPACK_COMPAT__PLUGIN_DIR . 'load-jetpack.php';
